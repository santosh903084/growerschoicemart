...
export const Signup = () => {
  ...
  const signUpHandler = async (signUpData) => {
    try {
      ...
      newUserRef.set({
        ...
        // Note: It's not recommended to store passwords directly; consider using Firebase Authentication for that.
      });
      toast.success("Sign up Successful!!");
      navigate("/products");
    } catch (error) {
      console.log("Signup Error", error);
      toast.success("Signup Success, Please Login Again", error);
      navigate("/login");
    }
  };
  ...
  const fillDummyData = (e) => {
    ...
    form["passwordField"].value = "satya@123";
    form["confirmPasswordField"].value = "satya@123";
  };
